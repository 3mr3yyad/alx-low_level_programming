...
<script crossorigin="anonymous" defer="defer" type="application/javascript" src="https://github.githubassets.com/assets/code-menu-c743a13234fc.js"></script>
  ...
  <meta name="request-id" content="AEBE:6D4B:7E885E:B0F544:64ED5162" data-pjax-transient="true"/><meta name="html-safe-nonce" content="b953d7784e046d52344dfa3f2b81eb16154ea5f60d5e0d7a99e3cf643b090cb2" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiJBRUJFOjZENEI6N0U4ODVFOkIwRjU0NDo2NEVENTE2MiIsInZpc2l0b3JfaWQiOiIzMTgwOTg0Nzk1NTIwNjUxNjE4IiwicmVnaW9uX2VkZ2UiOiJpYWQiLCJyZWdpb25fcmVuZGVyIjoiaWFkIn0=" data-pjax-transient="true"/><meta name="visitor-hmac" content="e5363044ccce9315bdc9286106278583cad1223f6687593c6aeb1c31db7a0f96" data-pjax-transient="true"/>
...
<qbsearch-input class="search-input" data-scope="repo:alx-tools/0x06.c" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="NWr1K4SiuF4QY8cbCaUKlMcl3N6yQgdkbVx47hgcTDRN-s7mfRV4IRYNIOhNt79JP_ODI3dGaM73q5Q9AhVDPw" data-max-custom-scopes="10" data-header-redesign-enabled="false" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="alx-tools/0x06.c" data-current-org="alx-tools" data-current-owner="" data-logged-in="false">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-2f5a0a5c-d55b-477a-a208-da31ec485574" data-target="query-builder.input" data-action="
...
<template id="pencil-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-pencil">
    <path d="M11.013 1.427a1.75 1.75 0 0 1 2.474 0l1.086 1.086a1.75 1.75 0 0 1 0 2.474l-8.61 8.61c-.21.21-.47.364-.756.445l-3.251.93a.75.75 0 0 1-.927-.928l.929-3.25c.081-.286.235-.547.445-.758l8.61-8.61Zm.176 4.823L9.75 4.81l-6.286 6.287a.253.253 0 0 0-.064.108l-.558 1.953 1.953-.558a.253.253 0 0 0 .108-.064Zm1.238-3.763a.25.25 0 0 0-.354 0L10.811 3.75l1.439 1.44 1.263-1.263a.25.25 0 0 0 0-.354Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-2f5a0a5c-d55b-477a-a208-da31ec485574" hidden="hidden">
...
<div class="Overlay--hidden Overlay-backdrop--center" data-modal-dialog-overlay>
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="AI3yrSLj6CE8ukxo+vKH9ZS5Wybir/7kwaT3K+Q4apx+KFMAU9F6MO73OvCT1wq72lDhxuZt/dMR1qUA7Gy70g==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <div data-view-component="true" class="Overlay-body">        <div data-target="custom-scopes.customScopesModalDialogFlash"></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="7n2/CHuv8E5VQ1XKvAF+fvQVFBvn3eHNTD90A5zWF+VXQoob+CzNx5KOY8+9X3S9qEw92v2PrdLEBpMSX1hM7A==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="qt7JuXyL6LT4mjspz7sbSoXZwdvf1gCllPRr/RptQQgi8r4Aulr1KxqSSsNk9xxEDatprVflyP3kXLO1r4mbNQ==" />
            </auto-check>
          </div>
...
</qbsearch-input><input type="hidden" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" value="CsBOMJY/q34S+fXO+OynaPyUk5z4VQ7z6B0Be4vp2QWygPLbDSOJNALXBFSiOFi1upfb87JBTJ0j1Lzehpq4iQ==" />
      ...
      <div class="text-small color-fg-muted">
        No packages published <br>
            ...
            <div class="BorderGrid-row" hidden>
              <div class="BorderGrid-cell">
                <include-fragment src="/alx-tools/0x06.c/used_by_list" accept="text/fragment+html">
</include-fragment>
              </div>
            </div>
